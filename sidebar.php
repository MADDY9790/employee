      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
         <li class="nav-item dropdown">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-file">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=upload" class="nav-link nav-upload tree-item">
              ...
              <li class="nav-item">
                <a href="./index.php?page=download" class="nav-link nav-download tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Download</p>
                </a>
              </li>
